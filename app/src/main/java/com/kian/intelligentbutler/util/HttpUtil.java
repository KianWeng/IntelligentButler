...
import com.kian.intelligentbutler.baidu_speech.unit.AccessTokenParser;
...
public class HttpUtil {
    ...
    public <T> void get(String path, final Parser<T> parser, final OnResultListener<T> listener){
        Request.Builder requesetBuilder = new Request.Builder().url(path);
        requesetBuilder.method("GET",null);
        ...
        call.enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                try {
                    ...
                    if (accessToken != null) {
                        UnitAPIService.getInstance().setAccessToken(accessToken.getAccessToken());
