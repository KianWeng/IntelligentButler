...
import com.kian.intelligentbutler.baidu_speech.ErrorTranslation;
    ...
    public void onEvent(String name, String params, byte[] data, int offset, int length) {
        ...
        if (name.equals(SpeechConstant.CALLBACK_EVENT_ASR_LOADED)){
            ...
            if (data.length != length) {
                PPLog.e(TAG, "internal error: asr.audio callback data length is not equal to length param");
            }
